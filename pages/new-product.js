...
const NewProduct = () => {
  ...
  //Custom hook
  const { values, errors, submitForm, handleChange, handleSubmit, handleBlur } = useValidation(INITIAL_STATE, validateNewProduct, createProduct);
              ...
              <Form onSubmit={handleSubmit} novalidate>
                <fieldset>
                  ...
                  <Field>
                      ...
                      <input type="text" id="name" placeholder="Enter product name" name="name" value={name} onChange={handleChange} onBlur={handleBlur}/>
                  </Field>
                  ...
                  <Field>
                      ...
                      <input type="text" id="company" placeholder="Enter the company" name="company" value={company} onChange={handleChange} onBlur={handleBlur}/>
                  </Field>
                  ...
                  <Field>
                      ...
                      <FileUploader accept="image/*"  id="image" name="image"
                      randomizeFilename 
                  ...
                  <Field>
                      ...
                      <input type="url" id="url" placeholder="Enter product URL" name="url" value={url} onChange={handleChange} onBlur={handleBlur}/>
                  </Field>
                ...
                <fieldset>
                  ...
                  <Field>
                      ...
                      <textarea id="description" placeholder="Enter a product description" name="description" value={description} onChange={handleChange} onBlur={handleBlur}/>
                  </Field>
